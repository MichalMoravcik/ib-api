  ...
  context 'Syntetic Message' do
    let(:the_message) do
      IB::Messages::Incoming::OpenOrder.new(
        ['4', '14217', 'SIE', 'STK', '', '0', '?', '', 'SMART', 'EUR', 'SIE', 'XETRA', 'BUY', '1', 'LMT', '70.0', '0.0',
         'GTC', '', 'DU4035275', '', '0', '', '2000', '727847514', '0', '0', '0', '', '', '', '', '', '', '', '', '0', '', '', '0', '', '-1', '0', '', '', '', '', '', '2147483647', '0', '0', '0', '', '3', '0', '0', '', '0', '0', '', '0', 'None', '', '0', '', '', '', '?', '0', '0', '', '0', '0', '', '', '', '', '', '0', '0', '0', '2147483647', '2147483647', '', '', '0', '', 'IB', '0', '0', '', '0', '0', 'Submitted', '1.7976931348623157E308', '1.7976931348623157E308', '1.7976931348623157E308', '1.7976931348623157E308', '1.7976931348623157E308', '1.7976931348623157E308', '1.7976931348623157E308', '1.7976931348623157E308', '1.7976931348623157E308', '', '', '', '', '', '0', '0', '0', 'None', '1.7976931348623157E308', '1.7976931348623157E308', '1.7976931348623157E308', '1.7976931348623157E308', '1.7976931348623157E308', '1.7976931348623157E308', '0', '', '', '', '0', '1', '0', '0', '0', '', '', '0']
        ## trailing_unit               |
        # #cash_qty
      )
    end
    ...
    it 'references to the right contract' do
      siemens = IB::Stock.new symbol: 'SIE', exchange: 'XETRA', currency: 'EUR'
      expect(the_message.contract).to eq siemens
    end

    it 'references to the correct order' do
      expect(the_message.order.perm_id).to eq 727_847_514
